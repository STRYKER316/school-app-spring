...
@Component
@Profile("!prod")
public class NonProdEnvUsernamePwdAuthProvider implements AuthenticationProvider {

    private final PersonRepository personRepository;

    @Autowired
    public NonProdEnvUsernamePwdAuthProvider(PersonRepository personRepository) {
